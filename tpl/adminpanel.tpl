...
<html lang="ru">
  <head>
    ...
    <link rel="shortcut icon" href="/images/guitar.ico" type="image/x-icon">
    <!-- Bootstrap -->
...
<nav class="slidenav navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="container-fluid" >
       <div class="row-fluid">
          ...
          '<form  align="center" action="adminpanel" class="authorization" method="post">
              <fieldset>
                <legend>Панель администратора:</legend>
                <br>
                <input type="submit" value="Создать новость" name="createNews">
                <br>
                <input type="submit" value="Редактировать новость" name="redactionNews">
                <br>
                <input type="submit" value="Удалить новость" name="deleteNews">
                <br>
              </fieldset>
           </form>'
